...
namespace Stratis.Features.SystemContracts.Tests.Contracts
{
    ...
    public class AuthContract
    {
        ...
        public IEmbeddedContractContainer Container { get; }

        public Network Network { get; }

        public bool IsAuthorised(string[] signatures)
        {
            return VerifySignatories(signatures, this.Container.PrimaryAuthenticators?.Signatories ?? new string[] { });
        }
        ...
        public class Dispatcher : IDispatcher<AuthContract>
        {
            ...
            public Dispatcher(IEmbeddedContractContainer systemContractContainer)
            {
